...
class WebsiteSetting(models.Model):
    ...
    hero_text_en = models.TextField(blank=True, verbose_name='النص التعريفي الرئيسي بالإنجليزية')
    about_title = models.CharField(max_length=250, default='رياضة باحترافية.. مستقبل بلا حدود', verbose_name='عنوان نبذة الشركة')
    about_title_en = models.CharField(max_length=250, blank=True, verbose_name='عنوان نبذة الشركة بالإنجليزية')
    about_text = models.TextField(blank=True, verbose_name='نبذة عن الشركة')
    about_text_en = models.TextField(blank=True, verbose_name='نبذة عن الشركة بالإنجليزية')
...
class Academy(models.Model):
    ...
    name_en = models.CharField(max_length=200, blank=True, verbose_name='اسم الأكاديمية بالإنجليزية للموقع')
    ...
    website_image_data = models.BinaryField(null=True, blank=True, editable=False, verbose_name='بيانات صورة الأكاديمية للموقع')
    website_image_content_type = models.CharField(max_length=100, blank=True, editable=False, verbose_name='نوع صورة الأكاديمية للموقع')
    website_image_name = models.CharField(max_length=255, blank=True, editable=False, verbose_name='اسم صورة الأكاديمية للموقع')
    ...
    manager_photo_content_type = models.CharField(max_length=100, blank=True, editable=False, verbose_name='نوع صورة مدير الأكاديمية')
    manager_photo_name = models.CharField(max_length=255, blank=True, editable=False, verbose_name='اسم صورة مدير الأكاديمية')
    manager_bio = models.TextField(blank=True, verbose_name='نبذة عن مدير الأكاديمية')
    manager_bio_en = models.TextField(blank=True, verbose_name='نبذة عن مدير الأكاديمية بالإنجليزية')
...
class AcademyMember(models.Model):
    ...
    name_en = models.CharField(max_length=200, blank=True, verbose_name='الاسم بالإنجليزية للموقع')
    ...
    job_title_en = models.CharField(max_length=200, blank=True, verbose_name='الوظيفة بالإنجليزية للموقع')
    ...
    website_bio_en = models.TextField(blank=True, verbose_name='نبذة المدرب بالإنجليزية على الموقع')
...
class Shareholder(models.Model):
    ...
    job_title_en = models.CharField(max_length=200, blank=True, verbose_name='الوظيفة / الصفة بالإنجليزية للموقع')
    website_bio = models.TextField(blank=True, verbose_name='نبذة عضو مجلس الإدارة')
    website_bio_en = models.TextField(blank=True, verbose_name='نبذة عضو مجلس الإدارة بالإنجليزية')
    photo_data = models.BinaryField(null=True, blank=True, editable=False, verbose_name='بيانات الصورة')
    photo_content_type = models.CharField(max_length=100, blank=True, editable=False, verbose_name='نوع ملف الصورة')
    photo_name = models.CharField(max_length=255, blank=True, editable=False, verbose_name='اسم ملف الصورة')
    is_published_on_website = models.BooleanField(default=True, verbose_name='إظهار العضو على الموقع')
