...
PUBLIC_TEXT = {
    'ar': {
        ...
        'phone': 'الهاتف', 'email': 'البريد الإلكتروني', 'address': 'العنوان', 'location': 'الموقع',
        'whatsapp': 'تواصل عبر واتساب', 'whatsapp_label': 'واتساب',
    ...
    'en': {
        ...
        'whatsapp': 'Contact Us on WhatsApp', 'whatsapp_label': 'WhatsApp',
